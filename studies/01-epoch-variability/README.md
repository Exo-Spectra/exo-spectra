...
at FDR 1% (15 planets). Gold sample: 8/47 discrepant, all late-K/M hosts.
With the offset+slope model the gold-sample discrepancies drop from 8 to 4:
a smooth slope absorbs the disagreement for TOI-260 b, TOI-776 c and one of
the two TOI-776 b pairs (the textbook signature of unocculted-spot
contamination), while GJ 1132 b, TOI-5205 b and the second TOI-776 b pair
keep structural, band-like differences.
...
| `results/GJ_1214_b_overlay.png`, `results/HD_189733_b_overlay.png` | case-study overlay plots (stable vs. active-star benchmark planets) |
